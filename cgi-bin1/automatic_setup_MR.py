...
if len(ip_list)>0:
 print "<br>"
 print "<br>"
 print "<font size='6' style='margin:0px;display:block;color:white;margin-left:700px;text-decoration:none;width:1500px;padding:14px 16px;'><i>Scanned IPs</i></font>"
