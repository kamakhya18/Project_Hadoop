...
status = commands.getstatusoutput("sudo sshpass -p 'redhat' ssh -o 'StrictHostKeyChecking no' root@"+ip_jobtracker+" hadoop jar /usr/share/hadoop/hadoop-examples-1.2.1.jar "+operation+" "+in_file)
...
print "<br>"
print "<br>"
print "<a style='color:white;text-decoration:none;font-size:30;float:right;' href='mr_options1.py'>"
print "Back"
print "</a>"
print "<br>"
print "<br>"
