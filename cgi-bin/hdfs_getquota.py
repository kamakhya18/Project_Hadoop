...
print "<pre>"
nameQuota = commands.getoutput("sudo hadoop fs -count -q "+dir_name+" | awk '{print $1}'")

spaceQuota = commands.getoutput("sudo hadoop fs -count -q "+dir_name+" | awk '{print $3}'")

print "<font size='5'>"

print "Name Quota "+nameQuota+"\nSpace Quota "+spaceQuota+"\n"
