...
print "<ul>"
print "<li style='margin:0px; display: block; color: white;text-align: center;padding: 14px 16px;text-decoration: none; width:1000px;  postion:fixed; background-color:royalblue;'>Setup of Hive Cluster</li>"
print "</ul>"
...
"""
print "Hive Set Up successfull"

print "<form action='../cgi-bin/hive_options1.py'>"
print "<input type='text' placeholder='Enter query' name='query'>"
