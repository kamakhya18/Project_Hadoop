...
print "<ul>"
print "<li style='margin:0px; display: block; color: white;text-align: center;padding: 14px 16px;text-decoration: none; width:1000px; background-color:#6495ED;'>Automatic Setup of Map Reduce Cluster</li>"
print "<br>"
print "<br>"
print "</ul>"
